            ...
            <div className="menu">
                ...
                <div className="center">
                    <div className="mainform">
                        <form className="form-group" action="/saveQuestion" method="post" encType="multipart/form-data" onSubmit={this.props.handleSubmit}>
                            ...
                            <input type="file" className="form-control-file" style={{ marginBottom: '-15px', marginTop: '20px' }} name="image" /> <br /> <br />
                            <button type="submit" className="btn btn-dark submit" onClick={this.loadImage}>Submit</button> <br />
                        </form>
                    </div>
                </div>
            </div>
